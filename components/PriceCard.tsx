  ...
  return (
    <div className="flex flex-row justify-center">
          <div className="w-fit h-auto mx-5 bg-white rounded-xl text-center">
            ...
            <div className=" mb-5 font-semibold text-amber-600">
              <h4 className={usdPrice < oldPrice ? 'text-red-500 opacity-90' : 'text-green-500 opacity-90'}><span className="text-gray-700">$ </span>{usdPrice}</h4>
            </div>
          </div>
    </div>
  )
