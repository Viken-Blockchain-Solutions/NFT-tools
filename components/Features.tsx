  ...
  return (
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 lg:gap-x-12">
      <div className="mb-12 lg:mb-0">
        ...
        <h5 className="text-lg font-bold mb-4">Search and monitor your collections</h5>
        <p className="text-gray-500">
        Search your collections with ease and keep track of their value with up-to-date royalty and secondary sales data. You can even see who currently holds each asset in your collection.
        </p>
      </div>
      ...
      <div className="mb-12 md:mb-0">
        ...
        <h5 className="text-lg font-bold mb-4">Batch transfers made simple</h5>
        <p className="text-gray-500">
        Execute batch transfers of individual NFTs to multiple accounts in one transaction, making it easier than ever to manage large collections.
        </p>
      </div>
      ...
      <div className="mb-12 md:mb-0">
        ...
        <h5 className="text-lg font-bold mb-4">Stay in control of your assets</h5>
        <p className="text-gray-500">
        Take control of your assets with our secure website, allowing you to access all of the features you need to manage, analyze, and optimize your collections - anytime, anywhere.
        </p>
      </div>
    </div>
  </section>
